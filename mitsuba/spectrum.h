...
#define MI_CIE_MIN           400.f
#define MI_CIE_MAX           700.f
#define MI_CIE_SAMPLES       61
...
const float d65_table[MI_CIE_SAMPLES] = {
    82.7549f, 87.1204f, 91.486f,  92.4589f, 93.4318f, 90.057f,
    ...
    80.281f,  78.2842f, 74.0027f, 69.7213f, 70.6652f, 71.6091f
};
